 ...
 */
angular.module('controllers',[]).controller('searchPageCtrl',
    ['$scope','$rootScope','$stateParams','$state',"GetOfflineProductList","$ionicPopup",
        function ($scope,$rootScope,$stateParams,$state,GetOfflineProductList,$ionicPopup) {
            ...
            $scope.search=function () {
                $scope.PageParamDTO ={
                    ...
                    requestData:{
                        ...
                        description:$scope.param.productName
                    }
                };
                GetOfflineProductList.save($scope.PageParamDTO,function (data) {
                    $scope.param.productList=data.responseData;
                    angular.forEach( $scope.param.productList, function (item, index, array) {
                        if (item.productPrefecture=='10') {
                            $scope.param.productList.splice(index, 1);
                        }
                    });
