...
require.config({
    ...
    paths: {
        ...
        "customerFactory" : "services/customerFactory",
        "customerGlobal" : "services/customerGlobal",
        "customerDirective" : "directives/customerDirective",
        "customerRoute" : "routes/appCustomerRoute",
        "appCustomer" : "modules/appCustomer"
    },
    waitSeconds: 0,
    shim: {
        'moment' : ['jquery'],
...
require(['angular','angular-resource','angular-sanitize','angular-ui-router','angular-locale_zh-cn',
        ...
        'uiBootstrapTpls','customerFactory', 'customerGlobal',
        'customerDirective', 'customerRoute','appCustomer'],
    function (angular){
